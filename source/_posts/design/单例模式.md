...
[详细代码实现](<https://github.com/shawn520/algorithms/tree/master/src/design/creation/singleton> )

## 应用

`java.util.Collections` 是针对集合类的包装类，它的实现用到了单例模式，通过私有化构造方法，然后将所有的方法都用`static`关键字修饰。（类方法？）
